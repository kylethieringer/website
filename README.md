# website
condensed readme for easier use by me  

see [al-folio](https://github.com/alshedivat/al-folio) for all contributors and updated readme  

for my personal deployment:
- `git add .`
- `git commit -m "commit statement"`
- `git push`
- this will automatically deploy the website updates
  + give it time to update in the browser, may take a couple minutes even after successful deployment
